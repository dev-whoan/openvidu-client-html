 ...
 */
 ...
 async function getToken(mySessionId) {
     let sessionInfo = await createSession(mySessionId);
     let token = await createToken(mySessionId);
     return token;
 //	return createSession(mySessionId).then(sessionId => createToken(sessionId));
 }
 
 function createSession(customSessionId) {
     return new Promise((resolve, reject) => {
         $.ajax({
             type: "POST",
             url: APPLICATION_SERVER_URL + "sessions",
             data: JSON.stringify({ sessionId: customSessionId }),
 ...
 function createToken(sessionId) {
     ...
     return new Promise((resolve, reject) => {
         $.ajax({
             ...
             data: JSON.stringify({ nickname: myUserName, sessionId: sessionId }), // The sessionId and userNickname
             headers: { "Content-Type": "application/json" },
